...
#define T_PIN		19				// 20lx(laser)からのタイミングパルスを受け取るピン
...
int main(int argc, char** argv)
{
	...
	ros::init(argc, argv, "mx28_swing_centor");
	ros::NodeHandle n;
	//ros::Subscriber speed_sub = n.subscribe("conical/cmd", 1, cmd_callback);
	ros::Publisher position_pub = n.advertise<geometry_msgs::PoseStamped>("tomlaser/swing/centor/ang", 1);
	...
	wiringPiISR( t_pin, INT_EDGE_FALLING, interrupt);
